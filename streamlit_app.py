...
st.set_page_config(page_title="V28 ULTRA MEGA", layout="wide")
st.markdown("<h1 style=color:#00D1FF>FinTrade V28 - ULTRA MEGA + NIFTY50</h1>", unsafe_allow_html=True)
st.write("V27 HOLD GAIL Success - Now V28 with NIFTY50 Screener")
...
NIFTY50 = ["RELIANCE.NS","TCS.NS","INFY.NS","HDFCBANK.NS","ICICIBANK.NS","BHARTIARTL.NS","ITC.NS","SBIN.NS","LT.NS","KOTAKBANK.NS","AXISBANK.NS","BAJFINANCE.NS","ASIANPAINT.NS","MARUTI.NS","TITAN.NS","SUNPHARMA.NS","ULTRACEMCO.NS","NTPC.NS","POWERGRID.NS","ONGC.NS","WIPRO.NS","HCLTECH.NS","BAJAJFINSV.NS","M&M.NS","ADANIENT.NS","ADANIPORTS.NS","COALINDIA.NS","HINDALCO.NS","JSWSTEEL.NS","TATASTEEL.NS","GRASIM.NS","CIPLA.NS","DRREDDY.NS","APOLLOHOSP.NS","DIVISLAB.NS","EICHERMOT.NS","BAJAJ-AUTO.NS","HEROMOTOCO.NS","BRITANNIA.NS","NESTLEIND.NS","TATACONSUM.NS","HINDUNILVR.NS","GAIL.NS","BPCL.NS","CUPID.NS","ETERNAL.NS","PAYTM.NS"]
