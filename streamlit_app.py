...
st.set_page_config(page_title='V18.4 CLEAN', layout='wide')
st.markdown('<h1 style="color:#00D1FF">FinTrade V18.4 - FINAL CLEAN</h1>', unsafe_allow_html=True)

TICKER_MAP = {'ZOMATO':'ETERNAL.NS','PAYTM':'PAYTM.NS','IRCTC':'IRCTC.NS'}
NAME_MAP = {'ETERNAL.NS':'ZOMATO','PAYTM.NS':'PAYTM','IRCTC.NS':'IRCTC'}
