...
def get_logo():
    try:
        with open("logo.png","rb") as f:
            import base64; return f'<img src="data:image/png;base64,{base64.b64encode(f.read()).decode()}" width="68" style="border-radius:16px;">'
...
WATCHLIST=[""]WATCHLIST=["RELIANCE","CUPID","INFY","TCS","HDFCBANK","ICICIBANK","SBIN","BHARTIARTL","ITC","BAJFINANCE","LT","MARUTI","TITAN","ASIANPAINT","WIPRO","ADANIENT","TATASTEEL","JSWSTEEL","NTPC","POWERGRID"]
